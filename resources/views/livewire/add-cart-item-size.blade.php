<div x-data>
    <div>
        ...
        <select wire:model="size_id" class="form-control w-full" name="" id="">
            <option value="" selected disabled>Selccione una Talla</option>
    ...
    <div class="flex mt-4">
        ...
        <div class="flex-1">
            <x-button x-bind:disabled="$wire.qty > $wire.quantity"  x-bind:disabled="!$wire.quantity" wire:click="addItem" wire:loading.attr="disabled" wire:target="addItem" color="orange" class="w-full">
